...
const DICT = {
  ko: {
    ...
    /* Course Detail System Flow (KO) */
    'course.systemFlow': '핵심 시스템 구조 & 데이터 흐름',
    'flow.101.n1': '사용자 질문 (User Input)',
    'flow.101.n2': 'Dify 의도 분류기 (Router)',
    'flow.101.n3': '지식 문서 조회 (RAG)',
    'flow.101.n4': '프롬프트 컴파일러',
    'flow.101.n5': 'LLM 답변 생성',
    'flow.101.n6': '최종 답변 UI',
    'flow.101.desc': '사용자의 질문 의도를 Dify 라우터로 분석하고, 적합한 RAG 문서 컨텍스트를 프롬프트와 결합하여 최적의 LLM 답변을 도출하는 6단계 실전 RAG 파이프라인입니다.',
    'flow.201.n1': '피그마 스타일 (Figma Styles)',
    'flow.201.n2': 'Figma MCP API',
    'flow.201.n3': '디자인 토큰 명세 (JSON)',
    'flow.201.n4': 'Claude Code AI 에이전트',
    'flow.201.n5': '컴포넌트 자동 생성 (React)',
    'flow.201.n6': '스토리북/코드베이스 싱크',
    'flow.201.desc': '피그마의 디자인 변수와 스타일을 Figma MCP로 추출하여 JSON 토큰 데이터로 정규화한 뒤, Claude Code를 통해 리액트 코드로 자동 변환 및 싱크하는 디자인 시스템 자동화 파이프라인입니다.',
    'flow.301.n1': '고객 인바운드 콜/챗',
    'flow.301.n2': '대화 흐름 매니저 (Dialog)',
    'flow.301.n3': '사내 SOP 참조 (RAG)',
    'flow.301.n4': '외부 DB 조회 API (Tool)',
    'flow.301.n5': '액션 노드 실행 (주문/예약)',
    'flow.301.n6': '상담사/AICC 웹 인터페이스',
    'flow.301.desc': '고객의 문의 의도를 분류하여 사내 SOP 문서를 참조(RAG)하거나, API를 통해 DB에서 고객 정보를 실시간으로 조회하여 대화형으로 예약/주문을 처리하는 대화형 에이전트 아키텍처입니다.',
    'flow.401.n1': '고객 행동 (웹훅 트리거)',
    'flow.401.n2': 'n8n 자동화 워크플로우',
    'flow.401.n3': 'Dify 카피라이터 에이전트',
    'flow.401.n4': 'Midjourney 이미지 프롬프트',
    'flow.401.n5': 'CRM 메시징 발송 API',
    'flow.401.n6': '알림톡/이메일 개인화 수신',
    'flow.401.desc': '가입이나 장바구니 이탈 등 고객 이벤트를 감지하여 n8n 워크플로우를 가동하고, Dify 카피라이터 에이전트와 미드저니 프롬프트 빌더로 개인화된 메시지/비주얼을 제작해 실시간 발송하는 CRM 자동화 파이프라인입니다.',
  ...
  en: {
    ...
    /* Course Detail System Flow (EN) */
    'course.systemFlow': 'Core System Structure & Data Flow',
    'flow.101.n1': 'User Question',
    'flow.101.n2': 'Dify Intent Router',
    'flow.101.n3': 'RAG Knowledge Base',
    'flow.101.n4': 'Prompt Compiler',
    'flow.101.n5': 'LLM Generation',
    'flow.101.n6': 'UI Output',
    'flow.101.desc': 'A 6-step practical RAG pipeline that analyzes user question intent with a Dify router, retrieves context from vector database documents, and compiles them into a prompt for optimal LLM generation.',
    'flow.201.n1': 'Figma Styles/Variables',
    'flow.201.n2': 'Figma MCP API',
    'flow.201.n3': 'Design Tokens (JSON)',
    'flow.201.n4': 'Claude Code Agent',
    'flow.201.n5': 'React Component Code',
    'flow.201.n6': 'Storybook & Codebase Sync',
    'flow.201.desc': 'A design token synchronization pipeline that exports Figma styles via Figma MCP into structured JSON metadata, allowing Claude Code to auto-generate and synchronize React components into the codebase.',
    'flow.301.n1': 'Inbound Call/Chat',
    'flow.301.n2': 'Dialog Flow Manager',
    'flow.301.n3': 'Company SOP (RAG)',
    'flow.301.n4': 'API Query (DB Tool)',
    'flow.301.n5': 'Action Node execution',
    'flow.301.n6': 'AICC Web Interface',
    'flow.301.desc': 'An interactive conversational agent architecture that classifies user inquiries, retrieves reference documentation via RAG, and processes transactions (order/booking) using API database tools.',
    'flow.401.n1': 'Customer Event (Webhook)',
    'flow.401.n2': 'n8n Automation Flow',
    'flow.401.n3': 'Dify AI Copywriter',
    'flow.401.n4': 'Midjourney Visuals Builder',
    'flow.401.n5': 'CRM Messaging API',
    'flow.401.n6': 'Personalized Messaging',
    'flow.401.desc': 'An event-driven CRM marketing automation pipeline that listens for customer activity webhooks, initiates n8n loops, calls a Dify copywriter to draft personalized contents, and distributes them via Messaging APIs.',
